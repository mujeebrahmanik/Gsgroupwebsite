                    ...
                    <div className="mx-auto container max-w-7xl text-base">
                        <div className="flex justify-between items-center">
                            ...
                            <div className="lg:hidden flex flex-row gap-6 justify-end">
                                <Link href='/contact' className="flex lg:hidden capitalize items-center gap-2 bg-primary text-white rounded-full px-4 py-3 font-medium capitalize text-sm hover:bg-black hover:text-white cursor-pointer">
                                    get in touch
                                </Link>
